...
if [ "${_BRANCH#*libressl*}" != "${_BRANCH}" ] ; then
   ...
   if [ "${_BRANCH#*dev*}" != "${_BRANCH}" ] ; then
      ...
      gpg -q --keyserver hkps://pgp.mit.edu --recv-keys D9C4D26D0E604491 D3577507FA40E9E2 9195C48241FBF7DD DFAB592ABDD52F1C 4F6DE1562118CF83 AA589DAC5A6A9B85 2064C53641C25E5D 0833F510E18C1C32
      gpg --verify pack.sig pack.bin || exit 1
